...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference("Point.count") do
      post points_url, params: { point: { geometry: @point.geometry, properties: @point.properties, type: @point.type } }, as: :json
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { geometry: @point.geometry, properties: @point.properties, type: @point.type } }, as: :json
    assert_response :success
  end
